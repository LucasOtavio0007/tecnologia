...
export const useSiteStore = defineStore('site', () => {
  ...
  function aplicarTema(t) {
    ...
    if (t === 'claro') {
      ...
      document.body.classList.remove('gold-bezel') // gold-bezel não deve estar no modo claro
    } else {
  ...
  function aplicarFonte(f) {
    // Remove classes existentes de tamanho de fonte
    ...
    if (f === 'pequena') {
      ...
      document.body.classList.add('fonte-normal') // 'normal' ou qualquer outro
    }
  }
